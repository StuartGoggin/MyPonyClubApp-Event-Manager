 ...
 * @return true if approval is required, false if it can be sent automatically
 */
 ...
 * @param emailType - The type of email being sent
 * @param config - The email queue configuration
 * @return 'draft' if approval required, 'pending' if ready to send
 */
 ...
 * @param emailType - The type of email being sent
 * @param config - The email queue configuration
 * @return true if email should be sent immediately, false if it should wait for approval
 */
