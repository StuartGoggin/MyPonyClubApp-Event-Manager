...
const basicZonesSeedData: Zone[] = [
  {
    id: 'zone-central',
    name: 'Central Zone',
    secretary: { name: 'Admin User', email: 'admin@centralzone.com', mobile: '0400 000 000' },
    eventApprovers: [
      { name: 'Admin Approver', email: 'approver@centralzone.com', mobile: '0400 000 001' }
    ],
    scheduleApprovers: [
      { name: 'Admin Schedule', email: 'schedule@centralzone.com', mobile: '0400 000 002' }
    ],
...
export async function callSeedData(): Promise<{ success: boolean; message: string }> {
  try {
