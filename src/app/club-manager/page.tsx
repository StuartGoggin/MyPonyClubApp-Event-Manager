...
export default function ClubEventManagerDashboard() {
  ...
  return (
    <div className="space-y-4 bg-gradient-to-br from-slate-50/50 via-background to-blue-50/30 min-h-screen p-4">
      {/* Compact Enhanced Header */}
      <Card className="enhanced-card glass-effect border-2 border-border/40 shadow-xl shadow-primary/10 bg-gradient-to-r from-white/95 via-white/90 to-primary/5">
      ...
      {selectedClub && (
        <div className="bg-gradient-to-r from-slate-100/40 via-background/80 to-blue-100/40 p-4 rounded-xl border border-border/30 shadow-inner space-y-4">
