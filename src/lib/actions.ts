...
// Import additional functions from serverActions
import { loadClubZoneData, type ZoneData } from './data-processor';

/**
 * Load data from ClubZoneData.json file (comprehensive dataset)
 */
...
/**
 * Simplified seed data function
 */
export async function callSeedData() {
  return {
    success: true,
    message: 'Seed data function available - use Firebase Functions for full seeding'
  };
}